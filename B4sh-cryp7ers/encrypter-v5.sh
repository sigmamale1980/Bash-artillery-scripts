#!/bin/bash
	...
	enkey=$(cat $keyring.pub.keyd|tr 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' '1234567890!@#$%^&*(){}|\,.?'|tr 'abcdefghijklmopqrstuvwxyz' '0987654321|;-+=[]/~()_+:<>')
	...
	encode=$(cat $keyring.priv.keyd|tr 'ABCDEFGHIJKLMNOPQRSTUVWXYZ' '1234567890!@#$%^&*(){}|\,.?'|tr 'abcdefghijklmopqrstuvwxyz' '0987654321|;-+=[]/~()_+:<>')
